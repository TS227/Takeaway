  ...
  <div class="row d-flex justify-content-center w-100">
    ...
    <div class="col-12 col-lg-4 order-lg-2">
      ...
      <div>
        ...
        if ($isFav) {
          ?>
          <button id="removeFav" type="button" class="btn btn-danger" data-foodid="<?php echo $_GET['id']; ?> ">Remove
            from
            favourites</button>
          <?php
        } else {
          ?>
          <button id="addFav" type="button" class="btn btn-success" data-foodid="<?php echo $_GET['id']; ?> ">Add to
            favourites</button>
          <?php
        }
        ?>
